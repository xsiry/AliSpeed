...
define(function(require, exports, module) {
    ...
    module.exports = {
        ...
        _bindUI: function() {
            ...
            // 按钮 查看走势图
            self_.on('click', '.x-game-stat-btn', function() {
                chartsDayConfirm();
            });
            // 数据表格动态高度
    ...
    function chartsDayConfirm() {
        ...
        $.confirm({
            title: "游戏点击|日走势图|" + date_str,
            content: 'url:../app/game_statistics_charts_dialog.html',
    ...
    function initCharts(days) {
        $.get('/click_statistics/q_game_charts', {date: days? days: 'all'}, function(result) {
            ...
            Highcharts.chart('game_statistics_charts', option);
        }, 'json');
    }
